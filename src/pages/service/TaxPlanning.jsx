...
const TaxPlanning = () => {
  ...
  const taxCards = [
    ...
    },
    {
      ...
      iconWrapClass: "bg-blue-500 text-white",
    ...
    },
    {
      ...
      iconWrapClass: "bg-teal-500 text-white",
      chipClass:
    ...
    },
    {
      ...
      bgClass: "bg-teal-50 border-teal-100",
      textClass: "text-teal-900",
      iconWrapClass: "bg-teal-600 text-white",
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {taxCards.slice(0, 3).map((card) => (
              ...
              >
                <div className="flex items-start gap-3 mb-3">
                  <div
                    className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm ${card.iconWrapClass}`}
                  >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={staggerContainer}
            className="mt-4 sm:mt-5 flex flex-col sm:flex-row flex-wrap justify-center items-stretch gap-4 sm:gap-5"
          >
            {taxCards.slice(3).map((card) => (
              <motion.div
                key={card.title}
                variants={scaleIn}
                whileHover={{ y: -3 }}
                className={`rounded-2xl p-5 sm:p-6 shadow-sm border ${card.bgClass} hover:shadow-md transition-all duration-300 w-full sm:max-w-md lg:max-w-lg`}
              >
                <div className="flex items-start gap-3 mb-3">
                  <div
                    className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm ${card.iconWrapClass}`}
